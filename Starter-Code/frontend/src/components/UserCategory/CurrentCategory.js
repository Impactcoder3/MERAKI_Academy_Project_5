        ...
        <div className="footer">
          ...
          >
            <li class="flex items-center">
              ...
              <span class="ml-2">Make sure the waste are dry </span>
            </li>
            <li class="flex items-center">
              <span
                style={{ backgroundColor: "#F3B811", color: "#FFFFFF" }}
            ...
            <li class="flex items-center">
              ...
              <span class="ml-2">Check out their measurement carefully</span>
            </li>
            <li class="flex items-center">
              <span
                style={{ backgroundColor: "#F3B811", color: "#FFFFFF" }}
            ...
            <li class="flex items-center">
              ...
              <span class="ml-2">
                Notes that there is a price that will show your own cash{" "}
              </span>
            </li>
            <li class="flex items-center">
              <span
